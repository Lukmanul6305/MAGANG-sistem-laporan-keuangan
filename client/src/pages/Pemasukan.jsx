  ...
  return (
    <div className={`flex flex-col p-5 transition-all duration-300 ease-in-out ${isOpen ? "lg:ml-70" : "lg:ml-20"} max-w-full  `}>
      <header className="flex w-full h-20 justify-between">
        ...
        <button onClick={(e) => alert("kepencet")} className="h-10">
          <img src="https://images.icon-icons.com/2468/PNG/512/user_kids_avatar_user_profile_icon_149314.png" className="w-10" alt="" />
        </button>
      </header>
        ...
        <form className="flex flex-col gap-1">
            ...
            <div className="w-full flex justify-end items-end h-20">
                <button className="bg-blue-600 p-2 w-30 rounded-2xl">Buat</button>
            </div>
        </form>
    </div>
  );
